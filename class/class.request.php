	...
	function requestNew()
	{
		...
		switch ($_REQUEST['sub'])
		{
			...
			case 'save':
				...
				$row->request_show_pagination = $_REQUEST['request_show_pagination'];
		...
		switch ($_REQUEST['sub'])
		{
			...
			case 'save':
				...
				if (isset($_POST['condition_field_id']) && is_array($_POST['condition_field_id']))
				{
					...
					{
						if ($_POST['condition_value'][$condition_id] !== '')
						{
							...
							$AVE_DB->Query("
								...
								SET
									...
									condition_join	  	= '" . $_POST['condition_join'][$condition_id] . "',
									condition_status	= '" . ($_POST['condition_status'][$condition_id] = ($_POST['condition_status'][$condition_id] == '1') ? '1' : '0') . "'
								WHERE
									Id = '" . $condition_id . "'
							");
