		...
		<div id="tab1" class="tab_content" style="display: block;">
			...
			<table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
				...
				<tr>
					...
					<td colspan="3"><textarea class="mousetrap" {$dis} style="width:350px; height:60px" name="request_description" id="request_description">{$row->request_description|escape}</textarea></td>
				</tr>
		...
		<div id="tab2" class="tab_content" style="display: none;">
			...
			<table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
				...
				<tr>
					...
					<td rowspan="14">
						<textarea {$dis} name="request_template_main" id="request_template_main" wrap="off" style="width:100%; height:380px">{$row->request_template_main|escape|default:''}</textarea>
...
{include file="$codemirror_editor" conn_id="" textarea_id='request_template_main' ctrls='$("#RequestTpl").ajaxSubmit(sett_options);' height=420}
