...
$AVE_Template->assign('codemirror_connect', BASE_DIR . '/admin/codemirror/codemirror_connect.tpl');
$AVE_Template->assign('codemirror_editor', BASE_DIR . '/admin/codemirror/codemirror_editor.tpl');
